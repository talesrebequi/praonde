...
public final class busca_005fhotel_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<html>\r\n");
      out.write("\t     <body>\r\n");
      out.write("\t     \t<form action=\"consultaPedidoServlet\">\r\n");
      out.write("\t\t\t<h3>Consulta de pedidos</h3>\r\n");
      out.write("\t\t\t\t     \t\r\n");
      out.write("\t      \tParâmetro para a consulta:   <select size=\"1\" name=\"parametro\">\r\n");
      out.write("\t      \t<option value=\"idPedido\">Código</option>\r\n");
      out.write("\t      \t<option value=\"valorTotal\">Valor Total</option>\r\n");
      out.write("\t      \t<option value=\"condicao_pagamento\">Condição de Pagamento</option>\r\n");
      out.write("\t      \t<option value=\"entrega\">Entrega</option>\r\n");
      out.write("\t      \t<option value=\"dataEmissao\">Data de Emissão</option>\r\n");
      out.write("\t      \t<option value=\"status\">Status</option>\r\n");
      out.write("\t      \t</select>\r\n");
      out.write("\t      \t<br>\r\n");
      out.write("\t      \t<br>\r\n");
      out.write("\t      \t\r\n");
      out.write("\t      \tDimensão para a consulta:   <select size=\"1\" name=\"dimensao\"><br>\r\n");
