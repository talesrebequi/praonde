<%@ page import="java.util.*, Dao.*, Servlets.*" pageEncoding="UTF-8"%>
	     	<%	     		   		
			...
			ArrayList<CaronaOferecida> recentes = carofdao.getNovas(); 
     		...
     		int naoLidas = mdao.getNaoLidas(idUsuario);
	%>
<!DOCTYPE html>
<html lang="pt">
<head>
...
<!-- header -->
		<header>
			...
			<div class="wrapper">
				<h1><a href="index.jsp" id="logo">PraOnde</a></h1>
				<nav> 
					<ul id="menu">
					 	<li id="menu_active" ><a href="#"><span><span>Painel</span></span></a></li>
						<li class="nav2"><a href="adiciona_veiculo.jsp"><span><span> Cadastrar veículo</span></span></a></li>
			...
			<div class="wrapper">
				...
				<div class="text">
					<% if (sexo.equals("f")){ %>
						<p>Seja bem vinda, <%=usuario.getNome()%> !<span></span></p>
					<% }else{ %>
						<p>Seja bem vindo, <%=usuario.getNome()%> !<span></span></p>
					<%}%>
					<br/>
					<figure class="left marg_right1"><img src="http://www.grupocep.com.br/praonde/<%=foto%>" width=100/></figure>
					<br/>
					<% if (naoLidas==0){%>
						Não há novas mensagens! <br/><br/>
					<%}else if (naoLidas==1){%>
						Você possui 1 mensagem! <br/><br/>
					<%}else{%>	
						Você tem <%=naoLidas%> mensagens! <br/><br/>
					<%}%>
					Email registrado: <%=usuario.getEmail()%>
					<br/><br/><br/><br/>
					<a href="exibe_veiculo.jsp"><img title="Veículos cadastrados" src="images/icons/Truck-icon.png" height="72"/></a>&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="exibe_conversas.jsp"><img title="Suas mensagens" src="images/icons/Chat-icon.png"/></a>&nbsp;&nbsp;&nbsp;
					<a href="exibe_veiculo.jsp"><img title="Seus BitCoins" src="images/icons/Visa-icon.png"/></a>&nbsp;&nbsp;&nbsp;
					<a href="exibe_veiculo.jsp"><img title="Preferências de sua conta" src="images/icons/Gears-icon.png"/></a>&nbsp;&nbsp;&nbsp;
		...
		<article id="content">
			...
			<%
   					for (CaronaOferecida carona : recentes){
   						...
   						String foto2 = usu.getFoto(); 				

						
       		%>
			 
				<div class="wrapper">
					<figure class="left marg_right1"><img src="fotos/usuarios/<%=foto2%>" width=100/></figure>
