...
<%
	...
	int idVeiculo = 0;
	if(session.getAttribute("veiculo")!=null){
		idVeiculo = Integer.parseInt(session.getAttribute("veiculo").toString());
		session.removeAttribute("veiculo");
	}else if(request.getParameter("idVeiculo")!=null && Integer.parseInt(request.getParameter("idVeiculo"))!=0){
		...
		<article id="content">
			...
			<section class="col1">
					...
					<% for(Veiculo veiculo : veiculos){ %>
						<div class="wrapper pad_bot2">
							<figure class="left marg_right1">
							   <img src="http://www.grupocep.com.br/praonde/<%=veiculo.getFoto()%>" width=50/>
							</figure>
							<p class="pad_bot1 pad_top1">
		                    	<span class="color1">
		                        	<a href="exibe_veiculo.jsp?idVeiculo=<%=veiculo.getIdVeiculo()%>" >
		                        		<%=veiculo.getPlaca()%>
		                        	</a>
								</span>
							</p>
				...
				<section class="col2">
					...
					<div class="wrapper">
						<figure class="left marg_right1"><img src="http://www.grupocep.com.br/praonde/<%=vei.getFoto()%>" width=100/></figure>
						...
						<br /><br /><br /><br />
						<a href="altera_veiculo.jsp?idVeiculo=<%=idVeiculo%>" class="button left">Editar</a>
